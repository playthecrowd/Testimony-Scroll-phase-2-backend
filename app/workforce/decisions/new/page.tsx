...
import { getMyWorkforceOrganizations, getWorkforceAccess, listDepartments, getMyProfileName, getRoleBadgeLabel } from "@/services/supabase/workforce";
    ...
    >
      <div className="max-w-2xl mx-auto px-4 py-6 md:py-8">
        <div className="flex items-center justify-between mb-1">
          ...
          <Link href={`/workforce/decisions?org=${org.churchId}`} className="text-xs text-accent-blue hover:underline">
